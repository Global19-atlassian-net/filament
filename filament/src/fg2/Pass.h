...
public:
    using PassExecutor::PassExecutor;
    virtual ~PassBase() noexcept;
};
...
class Pass : public PassBase {
    ...
    explicit Pass(Execute&& execute) noexcept
            : PassBase(), mExecute(std::move(execute)) {
    }
