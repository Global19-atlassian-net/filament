...
// prevent implicit instantiation of Resource<Texture> which is a known type
extern template class Resource<Texture>;
extern template class ImportedResource<Texture>;
