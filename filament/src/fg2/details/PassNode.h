...
public:
    ...
    RenderPassNode(FrameGraph& fg, const char* name, PassBase* base) noexcept;
    RenderPassNode(RenderPassNode&& rhs) noexcept;
    ~RenderPassNode() noexcept override;

    RenderPass declareRenderTarget(FrameGraph& fg, FrameGraph::Builder& builder,
...
private:
    ...
    UniquePtr<PassBase, LinearAllocatorArena> mPassBase;
